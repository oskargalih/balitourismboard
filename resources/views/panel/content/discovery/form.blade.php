...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">{{ Request::is('panel/discovery/new') ? 'Create New' : 'Edit' }}</li>
  </ol>
</section>
    ...
    <div class="col-xs-12">
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">{{ Request::is("panel/discovery/edit/*") ? "Form Edit" : "Form Create New" }}</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" action="{{ Request::is("panel/discovery/edit/*") ? route('panelDiscoveryEditAction', @$discovery->id) : route('panelDiscoveryNewAction') }}" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="name" placeholder="Name" name="name" value="{{ @$discovery->name }}">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select name="city_id" class="form-control">
                  ...
                  <option value="{{ $cities->id }}" {!! (@$discovery->city->name == $cities->name) ? 'selected="true"' : '' !!}>{{ $cities->name }}</option>
                  @endforeach
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="tags" placeholder="Tags" name="tags" value="{{ @$discovery->tags }}">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <textarea class="form-control" name="description" rows="5">{{ @$discovery->description }}</textarea>
              </div>
            </div>
...
<!--             <div class="form-group">
          ...
          <div class="box-footer">
            <div class="pull-right">
              <a href="{{ route('panelDiscoveryList') }}" class="btn btn-default">Cancel</a>
